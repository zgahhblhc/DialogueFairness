opt = {'task': 'twitter',
       ...
       'model_file': '/mnt/home/liuhaoc1/ParlAI/models/original_ParlAI_twitter_seq2seq_model/twitter_seq2seq_model',
       ...
       'person_tokens': False,
       'dict_file': '/mnt/home/liuhaoc1/ParlAI/models/original_ParlAI_twitter_seq2seq_model/twitter_seq2seq_model.dict',
       'dict_initpath': None,
       ...
       'override': {'task': 'twitter', 'max_train_time': '205200', 'model': 'seq2seq', 'numsoftmax': '1', 'hiddensize': '1024', 'embeddingsize': '300',
                    'attention': 'none', 'numlayers': '3', 'rnn_class': 'lstm', 'learningrate': '1', 'dropout': '0.0',
                    'gradient_clip': '0.1', 'lookuptable': 'enc_dec', 'optimizer': 'sgd', 'embedding_type': 'glove', 'momentum': '0.9',
                    'batchsize': '32', 'batch_sort': 'True', 'truncate': '150', 'validation_every_n_secs': '600',
                    'validation_metric': 'ppl', 'validation_metric_mode': 'min', 'validation_patience': '18', 'save_after_valid': 'True',
                    'load_from_checkpoint': 'True', 'dict_lower': 'True', 'dict_maxtokens': '30000', 'log_every_n_secs': '15',
                    'model_file': '/mnt/home/liuhaoc1/ParlAI/models/original_ParlAI_twitter_seq2seq_model/twitter_seq2seq_model'},
